...
<nav class="navbar navbar-light bg-dark">
    ...
    <div class="mx-auto">
        <span class="text-success">Hi <?php echo $userRow['userEmail' ]; ?></span>
        <a class="btn btn-outline-success" href="create.php" role="button">Add Car</a>
        <a class="btn btn-outline-success" href="logout.php?logout" role="button">Sign out</a>
        <span class="text-success ml-5">status: admin</span><br><hr>
